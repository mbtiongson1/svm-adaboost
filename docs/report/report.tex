...
\title{Comparison of Boosted Perceptrons and Support Vector Machines for Binary Classification}

\numberofauthors{1}
\author{
\alignauthor
Marcus Rafael B. Tiongson\\
       \affaddr{AI201 -- Programming Assignment 4}\\
       \affaddr{Instructor: Pros Naval}\\
       \email{May 14, 2026}
}
